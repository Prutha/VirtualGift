...
<Module>
    ...
    <script>
      ...
      <div id='main'>
        <div id="head">
        	<h1><font color="#ff4444"> VIRTUAL GIFT </font></h1>
        </div>
        	
        <div id='give' style='display: none;'>
          <form id='gift_form'>
            <font size="4" color="#02679C">
            Select A Gift:
            </font><br>
            <span id='gifts'></span> <br>
            <font size="4" color="#02679C"><br>
            Select A Friend:<br>
            </font>
            <span id='friends'></span>
            <br>
            <a href='javascript:void(0);' onclick='giveGift();'>
            	<img src="http://dolphinblueinc.files.wordpress.com/2009/12/gift11.jpg" alt="Gift" height = 70px width=70px border="0" />
            </a><br>
          </form>
        </div><br>
